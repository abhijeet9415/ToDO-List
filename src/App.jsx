         ...
         <div className="todos">
          ...
          return (showFinished || !item.isCompleted) && <div key={item.id} className={"todo flex my-3 justify-between"}>
            ...
            <div className="buttons flex h-full">
              ...
              <button onClick={(e)=>{handleDelete(e, item.id)}} className='bg-red-400 hover:bg-red-800 p-2 py-1 text-sm font-bold text-white rounded-md mx-1'><AiFillDelete /></button>
            </div> 
          </div>
          })}
         </div>
